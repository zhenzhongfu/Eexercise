...
start(Interval) ->                                                   
    gen_server:start({local, ?MODULE}, ?MODULE, [Interval], []).     
...
%% 这里修改了一下，使用软清除
reload_modules(Modules, Force) ->                                        
    case Force of                                                        
        true ->                                                          
            [begin code:purge(M), code:load_file(M) end || M <- Modules];
        false ->                                                         
            [begin                                                       
                        Ret = code:soft_purge(M),                        
                        case Ret of                                      
                            true ->                                      
                                code:load_file(M);                       
                            false ->                                     
...
reload(Module) ->                                                           
    ...
    case Ret of                                                             
        ...
        false ->                                                            
            io:format(" fail: soft purge fail.~n"),                    
            error
    end.                                                                    
